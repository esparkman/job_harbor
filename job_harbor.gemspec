require_relative "lib/job_harbor/version"

Gem::Specification.new do |spec|
  spec.name        = "job_harbor"
  spec.version     = JobHarbor::VERSION
  spec.authors     = [ "Evan Sparkman" ]
  spec.email       = [ "evan@mountaingapcoffee.com" ]
  spec.homepage    = "https://github.com/esparkman/job_harbor"
  ...
  spec.metadata["source_code_uri"] = "https://github.com/esparkman/job_harbor"
  spec.metadata["changelog_uri"] = "https://github.com/esparkman/job_harbor/blob/main/CHANGELOG.md"
